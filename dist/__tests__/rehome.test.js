...
describe("User can rehome a digipet when they currently have one, but they can't if they don't have one.", () => {
    ...
    test("1st GET /digipet/rehome informs them that they can't rehome a non-existent digipet", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("2nd GET /digipet now informs them that they do currently have a digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield supertest_1.default(server_1.default).get("/digipet");
        expect(response.body.message).toMatch(/your digipet/i);
        expect(response.body.digipet).toBeDefined();
    }));
    test("2nd GET /digipet/rehome now informs them that they have rehomed their digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield supertest_1.default(server_1.default).get("/digipet/rehome");
        expect(response.body.message).toMatch(/success/i);
        expect(response.body.message).toMatch(/rehome/i);
        expect(response.body.digipet).not.toBeDefined();
    }));
    test("3rd GET /digipet/rehome informs them that they can't rehome a non-existent digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield supertest_1.default(server_1.default).get("/digipet/rehome");
        expect(response.body.message).not.toMatch(/success/i);
        expect(response.body.message).toMatch(/exist/i);
        expect(response.body.digipet).not.toBeDefined();
