...
describe("GET /digipet/rehome", () => {
    test("if the user doesn't have a digipet, it responds with a message explaining you can't rehome a digipet that doesn't exist", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup
        if (jest.isMockFunction(controller_1.rehomeDigipet)) {
        ...
        expect(controller_1.rehomeDigipet).toHaveBeenCalledTimes(0);
    }));
    test("if the user has a digipet, it responds with a message about successfully rehoming a digipet and calls rehomeDigipet", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup
...
describe("action routes", () => {
    ...
    describe("GET /digipet/ignore", () => {
        test("if the user has a digipet, it responds with a message about it being ignored", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
